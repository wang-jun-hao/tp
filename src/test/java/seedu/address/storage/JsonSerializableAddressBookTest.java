...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path INVALID_PATIENTS_FILE = TEST_DATA_FOLDER.resolve("invalidPatientAddressBook.json");
    ...
    public void toModelType_invalidPatientFile_throwsIllegalValueException() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(INVALID_PATIENTS_FILE,
                JsonSerializableAddressBook.class).get();
