...
class RemarkCommandTest {
    ...
    void execute_addRemarkUnfilteredList_success() {
        ...
        Person remarkedPerson = personInList.withRemark(REMARK_STUB).build();

        RemarkCommand remarkCommand = new RemarkCommand(indexLastPerson,
                new Remark(remarkedPerson.getRemark().value));
