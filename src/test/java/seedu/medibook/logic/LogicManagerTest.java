...
import static seedu.medibook.commons.core.Messages.MESSAGE_INVALID_PATIENT_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonMediBookIoExceptionThrowingStub
        JsonMediBookStorage mediBookStorage =
     ...
     */
    private static class JsonMediBookIoExceptionThrowingStub extends JsonMediBookStorage {
        private JsonMediBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
